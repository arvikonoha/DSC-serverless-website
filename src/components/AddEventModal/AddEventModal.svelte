<script>
  ...
  import Event from "../../Classes/Event/Event.js";
  ...
  function handleSubmit() {
    ...
    Event.addAuthEvent(
      ...
      .then(() => {
        uploadData = false;
        M.Modal.getInstance(document.getElementById("add-event")).close();
        M.toast({ html: "Event successfully added" });
        title = "";
        startdate = "";
        enddate = "";
        location = "";
...
<section id="add-event" class="modal">
  <form
    on:submit|preventDefault={handleSubmit}
    class="modal-content"
    action="POST">
    <div style="padding: 16px 32px;">
      <h2 style="font-size: 2rem" class="heading">Add a new event</h2>
